<?php
define('KOPA_THEME_NAME', 'Musica');
define('KOPA_DOMAIN', 'musica');
define('KOPA_CPANEL_IMAGE_DIR', get_template_directory_uri() . '/library/images/layout/');
define('KOPA_UPDATE_TIMEOUT', 21600);
define('KOPA_UPDATE_URL', 'http://kopatheme.com/notifier/musica.xml');
...
function kopa_register_required_plugins() {
	$plugins = array(
		array(
			'name'     				=> 'Kopa Musica Shortcodes', // The plugin name
			'slug'     				=> 'kopa-musica-shortcodes', // The plugin slug (typically the folder name)
			'source'   				=> get_template_directory() . '/plugins/kopa-musica-shortcodes.zip', // The plugin source
