    ...
    <form name="kopa-theme-options" id="kopa-theme-options" autocomplete="off" method="post" action="#">
        ...
        <div class="kopa-nav list-container">
            <ul class="tabs-1 clearfix">
                ...
                <li><span lang="#tab-custom-theme"><?php _e('Custom Color', kopa_get_domain()); ?></span></li>
                <li><span lang="#tab-custom-font"><?php _e('Custom Font', kopa_get_domain()); ?></span></li>
        ...
        <div class="kopa-content">
            ...
            <div class="tab-container">                      
                ...
                <?php include_once trailingslashit(get_template_directory()) . '/library/includes/cpanel/theme-options/custom-color.php'; ?>
                <?php include_once trailingslashit(get_template_directory()) . '/library/includes/cpanel/theme-options/custom-font.php'; ?>
