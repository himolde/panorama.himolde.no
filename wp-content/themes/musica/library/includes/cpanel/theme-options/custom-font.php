<div id="tab-custom-font" class="kopa-content-box tab-content tab-content-1">    
    ...
    <div class="kopa-box-body">
        ...
        <div class="kopa-element-box kopa-theme-options">            
            ...
            <p class="kopa-desc"><?php _e('Font weight', kopa_get_domain()); ?></p>
            <label class="kopa-label"><?php _e('Content font weight:', kopa_get_domain()); ?> </label>
            <input type="text" value="<?php echo get_option('kopa_theme_options_content_font_weight'); ?>" id="kopa_theme_options_content_font_weight" name="kopa_theme_options_content_font_weight" class=" kopa-short-input">    
        </div><!--kopa-element-box-->
        ...
        <?php 
        /**
         * Right sidebar: widget title font settings
         */
        ?>                                      
        <div class="kopa-element-box kopa-theme-options">            
            <p class="kopa-desc"><?php _e('Widget title font', kopa_get_domain()); ?></p>
            <?php
            ...
            ?>"><?php _e('Sample widget title font', kopa_get_domain()); ?></div>
            ...
            <p class="kopa-desc"><?php _e('Font size', kopa_get_domain()); ?></p>
            <label class="kopa-label"><?php _e('Widget title font size:', kopa_get_domain()); ?> </label>
            ...
            <p class="kopa-desc"><?php _e('Font weight', kopa_get_domain()); ?></p>
            <label class="kopa-label"><?php _e('Widget title font weight:', kopa_get_domain()); ?> </label>
